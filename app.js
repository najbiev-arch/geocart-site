...
const I18N = {
  ru: {
    ...
    toolCostTitle: "Сервис для расчета стоимости проекта",
    toolCostText: "Предварительная оценка бюджета проектных работ по параметрам территории, составу данных и видам услуг.",
    licenseEyebrow: "Лицензии",
    licenseTitle: "Лицензия на проектную деятельность",
    licenseLead: "Официальный документ Geocart для ознакомления и проверки.",
    licenseOpen: "Открыть лицензию",
  ...
  kk: {
    ...
    toolCostTitle: "Жоба құнын есептеу сервисі",
    toolCostText: "Аумақ параметрлері, деректер құрамы және қызмет түрлері бойынша жобалау жұмыстары бюджетінің алдын ала бағасы.",
    licenseEyebrow: "Лицензиялар",
    licenseTitle: "Жобалау қызметіне лицензия",
    licenseLead: "Танысу және тексеру үшін Geocart компаниясының ресми құжаты.",
    licenseOpen: "Лицензияны ашу",
  ...
  en: {
    ...
    toolCostTitle: "Project cost calculation service",
    toolCostText: "Preliminary budget estimate for project work based on territory parameters, data scope and service types.",
    licenseEyebrow: "Licenses",
    licenseTitle: "Project activity license",
    licenseLead: "Official Geocart document for review and verification.",
    licenseOpen: "Open license",
